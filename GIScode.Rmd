...
> Some sources may require a login and an enrollment to some instituon. Most of the files are very "heavy". 
...
source_folder<-"c:/Chris/UN-ESCAP/MyCourses/BigDataGender/Code/"
...
merged1<-read.csv(file = paste0(source_folder,'Data/bangladesh.csv'))  # reading DHS Bangladesh 2014
