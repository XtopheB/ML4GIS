...
subtitle: "Random Forest Model on GIS file (extracted from Blanca)"
...
DataForModel <- read.csv("Data/Dataset_for_model_wkt.csv")
...
upperLeft = c(-max(DataForModel$y), min(DataForModel$x))

lowerRight = c(min(DataForModel$y), max(DataForModel$x))
