...
## Predictors 
The list of explanatory variables (or *predictors*) are the different bands from the satellite images. For each location, we have a value from each band stored in a variable ($b_1$, $b_2$, $\cdots$, $b_12$). 
