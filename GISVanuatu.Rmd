...
levels(DataForModel$Class1)=c("Forest", "Non-Forest")
...
We can also assess the decision trees both *in sample*, that is how well the model estimates teh data within the training dataset  and *out of sample* performance, where we compare predictions based on a validation data set ("*unseen data*"). 
