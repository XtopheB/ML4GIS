...
> We may refer to the `r caret` [package manual](https://topepo.github.io/caret/model-training-and-tuning.html) to learn about all the options and models available. The algorithm that will be conducted all along this exercise is the following ![](https://topepo.github.io/caret/premade/TrainAlgo.png)
...
```
 The accuracy is **`r accuracy`** . We can compute some other indicators of interest. 
```{r, results=TRUE}
