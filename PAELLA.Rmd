...
> SMOTE changes the training data set, we will have a much larger data set for training our model. It means it is likely that the model overperforms in-sample and over-fits! 
