...
subtitle: "PAELLA - Component 2 - V1.0"
...
>**TODO** We can label the land classes for a better interpretation and visualization
...
```{r}
# Saving the Dataset for Modeling as a csv file to avoid rerunning theselengthy steps
save(DataForModel, file = "Data/GIS-ROI-V1/DataForModel.Rda")
...
```{r}
pfit_A <- plot(rf_fit, metric = "Accuracy")
# One can also plot the graphic with a different metric in mind.! 
pfit_K <-  plot(rf_fit, metric ="Kappa")
