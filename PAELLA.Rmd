...
combined_df <- combined_df %>%
  ...
  mutate(diff_class = ifelse(prediction_RF == prediction_logi, prediction_RF, "0"))

# Define the  augmented color class labels with the category "Difference" 
class_labels_N <- c("0" = "Difference", class_labels)

# Define the augmented color palette accordingly 
class_colors_N <- c("white", class_colors)

# Convert raster values to a factor with labels
combined_df$diff_class <- factor(combined_df$diff_class)
