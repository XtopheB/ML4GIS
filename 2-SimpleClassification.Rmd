...
+ If expected accuracy is $1/2$ as here, then $\kappa = 2 \times p_o -1$, there is no difference in ranking using $\kappa$ or observed accuracy.
...
> For a more in depth discussion of these concepts, see the post by Nina Zummel^[ See the post by Nina Zummel https://win-vector.com/2009/11/03/i-dont-think-that-means-what-you-think-it-means-statistics-to-english-translation-part-1-accuracy-measures/#wikiSS].
